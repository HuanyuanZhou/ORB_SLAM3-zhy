...
cv::Mat Tracking::GrabImageMonocular(const cv::Mat &im, const double &timestamp, string filename)
{
    ...
    //初始化当前帧类，Frame类中包含了的信息有：
    // (1)image; (2)ORB features; (3)current pose; (4) mvMappointsl; (5) camera intrinsics; (6)imu intrinsics等
...
void Tracking::Track()
{
    ...
    //根据LastKeyFrame设置新的imu bias,以上一关键帧的bias作为当前帧的初始bias
